...
const file_trip_proto_rawDesc = "" +
	...
	"\trideFares\x18\x03 \x03(\v2\x0f.trip.RideShareR\trideFares\"H\n" +
	"\n" +
	"Coordinate\x12\x1c\n" +
	...
	"\bGeometry\x122\n" +
	"\vcoordinates\x18\x01 \x03(\v2\x10.trip.CoordinateR\vcoordinates\"u\n" +
	"\tRideShare\x12\x0e\n" +
	...
	"totalPrice2Q\n" +
	"\vTripService\x12B\n" +
	"\vPreviewTrip\x12\x18.trip.PreviewTripRequest\x1a\x19.trip.PreviewTripResponseB\x19Z\x17shared/proto3/trip;tripb\x06proto3"
